    ...
    request(params) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                //     params.data,
                //     this.bridge.jsonStringify(params.data),
                //     this.bridge.jsonStringify(result)
                // );
                // this.log(
                //     LogLevels.info,
                //     `Executing action: ${actionPayload.action}, provider: ${actionPayload.provider}`,
                //     context
                // );
                return result;
            }
                ...
                //     this.bridge.jsonStringify(actionPayload.payload),
                //     e.message
                // );
                // this.log(
                //     LogLevels.error,
                //     `Error while executing action: ${actionPayload.action}, provider: ${actionPayload.provider}`,
                //     context
                // );
                throw e;
            }
